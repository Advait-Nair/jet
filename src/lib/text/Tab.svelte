...
<div bind:this={h4} class="jtt-wrapper flex items-center justify-between {notoppad ? '!pt-0' : ''}" class:pt-2={!notoppad} class:jtt-hash-touch={!nohashlink} id={procHash(id || generateId('tab', h4, icon))}>
